...
/**
 ** Platform-dependent shortcuts. This file contains all the static definitions
 ** of the shortcuts for each platform.
 **
 ** FIXME: Linux support needed
 **/
...
#define WIN_SC_START_OF_DOC  C(KC_HOME)     // Move to start ofdocument
...
#define MAC_SC_CUT_SELECTION   G(KC_X)       // Cut
#define MAC_SC_COPY_SELECTION  G(KC_C)       // Copy
#define MAC_SC_PASTE_CLIPBOARD G(KC_V)       // Paste
#define MAC_SC_UNDO_ACTION     G(KC_Z)       // Undo
#define MAC_SC_REDO_ACTION     S(G(KC_Z))    // Redo

#define WIN_SC_SELECT_ALL      C(KC_A)    // Select all
#define WIN_SC_CUT_SELECTION   C(KC_X)    // Cut
#define WIN_SC_COPY_SELECTION  C(KC_C)    // Copy
#define WIN_SC_PASTE_CLIPBOARD C(KC_V)    // Paste
...
#define WIN_SC_TAB_LEFT_ALT  WIN_SC_TAB_LEFT     // Same as above
...
#define WIN_SC_PREV_APP       KC_NO             // Does nothing FIXME
