...
/**
 ** Custom mouse keys. These are intended to make controlling the mouse from the
 ** keyboard easier than the standard QMK mouse keys.
 **
 ** For additional documentation, see
 ** https://github.com/frogm0uth/keyboard-notes/blob/master/qmk-custom-mouse/README.md
 **/
