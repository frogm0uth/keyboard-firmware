...
KEYMAPS(
  ...
  [PRIMARY] = KEYMAP_STACKED
  (___,          Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   Key_Backtick, Key_V, Key_C, Key_W, Key_F, Key_K, Key_Tab,
   Key_X,   Key_R, Key_S, Key_T, Key_H, Key_B,
   Key_LeftAlt, Key_LeftShift, Key_P, Key_G, Key_D, Key_Z, Key_Escape,
   Key_Quote, Key_E, Key_LeftGui, Key_LeftShift,
   ShiftToLayer(FUNCTION),

   M(MACRO_ANY),  Key_6, Key_7, Key_8,     Key_9,         Key_0,         LockLayer(NUMPAD),
   Key_Enter,     Key_J, Key_M, Key_U,     Key_Period,    Key_Minus,     Key_Backspace,
                  Key_Semicolon, Key_N, Key_I,     Key_O,         Key_A, Key_Q,
   Key_RightAlt,  Key_Pipe, Key_L, Key_Y, Key_Comma,    Key_RightShift,     Key_RightAlt,
