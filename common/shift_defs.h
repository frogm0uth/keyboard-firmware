...
//
DEFINE_SHIFT( CU_0, KC_0, KC_GRV )
DEFINE_SHIFT( CU_1, KC_1, KC_RCBR )
DEFINE_SHIFT( CU_2, KC_2, KC_PERC )
DEFINE_SHIFT( CU_3, KC_3, KC_LCBR )
DEFINE_SHIFT( CU_4, KC_4, KC_AT )
DEFINE_SHIFT( CU_5, KC_5, KC_TAB )
DEFINE_SHIFT( CU_6, KC_6, KC_6 )
DEFINE_SHIFT( CU_7, KC_7, KC_7 )
...
DEFINE_SHIFT( CU_LT,     KC_LABK, KC_AMPR )
DEFINE_SHIFT( CU_GT,     KC_RABK, KC_PIPE )
DEFINE_SHIFT( CU_DLR,    KC_DLR,  KC_CIRC )
DEFINE_SHIFT( CU_TILD,   KC_TILD, KC_GRV )
...
DEFINE_SHIFT( CU_BSLS_BSLS,  KC_BSLS, KC_BSLS )
DEFINE_SHIFT( CU_QUOT_QUOT,  KC_QUOT, KC_QUOT )

// Custom keys
DEFINE_SHIFT(CU_SCREEN_RL,   SC_NEXT_SCREEN, SC_PREV_SCREEN )
DEFINE_SHIFT(CU_TAB_RIGHT,   SC_TAB_RIGHT,   SC_TAB_LEFT )
DEFINE_SHIFT(CU_NEXT_WINDOW, SC_NEXT_WINDOW, SC_PREV_WINDOW )
DEFINE_SHIFT(CU_EXPOSE_ALL,  SC_EXPOSE_ALL,  SC_EXPOSE_ALL )
